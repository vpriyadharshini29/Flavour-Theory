...
function CloudKitchen() {
  return (
    <div className="bg-[#fff7f0] font-sans px-4 py-8 md:px-16">
      ...
      {/* Main Content */}
      <section className="bg-black bg-center rounded-3xl text-white p-6 md:p-10" style={{ backgroundImage: 'url(/assets/background-ingredients.jpg)' }}>
        <div className="grid md:grid-cols-2 gap-8 items-center">
          {/* Left Content */}
          <div>
            <h2 className="text-2xl md:text-3xl font-bold leading-snug">
              Launch & Grow Your CLOUD KITCHEN in the next 60 Days <br />
